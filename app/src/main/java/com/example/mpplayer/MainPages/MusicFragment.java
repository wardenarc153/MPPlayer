...
public class MusicFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        git.setOnClickListener(view1 -> navController.navigate(R.id.action_musicFragment_to_gitFragment));
        author.setOnClickListener(view1 -> navController.navigate(R.id.action_musicFragment_to_authorFragment));
        instruction.setOnClickListener(view1 -> navController.navigate(R.id.action_musicFragment_to_instructionFragment));
        infoProg.setOnClickListener(view1 -> navController.navigate(R.id.action_musicFragment_to_infoProgFragment));
